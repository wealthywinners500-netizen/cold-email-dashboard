...
// Fake public-range IP pool from RFC 5737 — TEST-NET-1 (192.0.2.0/24) and
// TEST-NET-2 (198.51.100.0/24). Reserved for documentation, won't appear in
// real BGP tables. Using two pools keeps dry-run pairs in different /24s so
// the pair-subnet diversity check (/12 in ip-blacklist-check.ts) passes.
const DRY_RUN_POOL_1 = "192.0.2.";
const DRY_RUN_POOL_2 = "198.51.100.";
...
// distinct subnets and passing the pair-diversity check.
